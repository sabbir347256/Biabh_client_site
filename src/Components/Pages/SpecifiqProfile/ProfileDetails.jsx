        ...
        <div className="app-container pb-8 min-h-screen bg-gray-50/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-16">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm border-l-red-600 border-l-4">
                        <div className="flex justify-between items-center mb-4 border-b pb-2">
                            <h2 className="text-lg font-bold text-red-600 flex items-center gap-2"><MapPin className="w-5 h-5" /> Addresses</h2>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center">
                        ...
                        {isProfileLocked ? (
                            <button type="button" onClick={handleUnlockProfile} className="w-full border border-red-200 hover:bg-red-50 text-red-600 py-3 rounded-xl font-semibold text-sm transition flex items-center justify-center gap-2 bg-red-50/30">
