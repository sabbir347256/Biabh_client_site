        ...
        <div className="flex min-h-screen text-gray-800 ">
            ...
            <div className="flex w-full mx-auto max-w-2xl flex-col justify-between bg-white px-8 py-12 lg:w-1/2 lg:px-24">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full rounded-lg border ${errors.identifier ? 'border-red-500' : 'border-gray-300'} px-4 py-3 outline-none transition focus:border-[#b30000] focus:ring-1 focus:ring-[#b30000]`}
                            />
                            {errors.identifier && (
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                id="remember"
                                {...register("rememberMe")}
                                className="h-4 w-4 rounded border-gray-300 text-[#b30000] focus:ring-[#b30000]"
                            />
                ...
                <div className="mt-12 flex flex-wrap items-center justify-between text-[10px] text-gray-500">
                    <p>© 2024 Bibah. Premium Bangladeshi Matchmaking.</p>
