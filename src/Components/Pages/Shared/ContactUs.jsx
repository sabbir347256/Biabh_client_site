            ...
            <div className="max-w-4xl w-full mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2 bg-white p-8 rounded-2xl shadow-sm border border-gray-100 border-b-4 border-b-red-600 flex flex-col sm:flex-row items-start gap-5">
                        ...
                        <div>
                            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-600">Corporate Office</h3>
                            ...
                            <p className="mt-1 text-sm font-medium text-gray-600 leading-relaxed">
                                Flat -7F1, Tower-7, Progoti Shoroni, Gulshan, Dhaka-1212. <br /> <span className="font-bold">Phone</span> : +88 01711994474,
                                 <br /> <span className="font-bold">Telephone</span> : +88 09644 840 940,
                            </p>
                        </div>
                        <div>
                            <h3 className="text-xs font-bold uppercase tracking-widest text-gray-600">Qatar Office</h3>
                            <p className="mt-1 text-sm font-medium text-gray-600 leading-relaxed">
